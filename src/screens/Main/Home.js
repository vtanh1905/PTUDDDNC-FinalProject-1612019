  ...
  return (
    <View>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Text style={{ textAlign: 'justify', fontWeight: '600', fontSize: 14, paddingHorizontal: 10, paddingBottom: 30 }}>
        ...
        <ListCourseHorizontal title={LISTCOURSES[1].title} data={LISTCOURSES[1].courses} navigation={navigation} />
      </ScrollView>
    </View>
  )
}
